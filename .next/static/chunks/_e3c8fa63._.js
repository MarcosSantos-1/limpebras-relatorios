...
"[project]/app/relatorios/evidencias-revitalizacoes/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EvidenciasRevitalizacoesPage() {
    ...
    const [tipoServico, setTipoServico] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("REVITALIZACAO");
    ...
    const [revitalizacoesCompletas, setRevitalizacoesCompletas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EvidenciasRevitalizacoesPage.useEffect": ()=>{
            const loadReports = {
                "EvidenciasRevitalizacoesPage.useEffect.loadReports": async ()=>{
                    try {
                        ...
                        const revitalizacoesIds = reports.filter({
                            "EvidenciasRevitalizacoesPage.useEffect.loadReports.revitalizacoesIds": (r)=>r.tipoServico === 'REVITALIZACAO'
                        }["EvidenciasRevitalizacoesPage.useEffect.loadReports.revitalizacoesIds"]).map({
                            "EvidenciasRevitalizacoesPage.useEffect.loadReports.revitalizacoesIds": (r)=>r.id
                        }["EvidenciasRevitalizacoesPage.useEffect.loadReports.revitalizacoesIds"]);
                        const revitalizacoesCompletas = [];
                        for (const id of revitalizacoesIds){
                            try {
                                const revitalizacaoCompleta = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReport"])(id);
                                if (revitalizacaoCompleta) {
                                    revitalizacoesCompletas.push(revitalizacaoCompleta);
                                }
                            } catch (error) {
                                console.error("Erro ao carregar revitalização ".concat(id, ":"), error);
                            }
                        }
            ...
            }["EvidenciasRevitalizacoesPage.useEffect.loadReports"];
            loadReports();
        }
    }["EvidenciasRevitalizacoesPage.useEffect"], []);
    ...
    async function handleExportEvidencias() {
        ...
        if (revitalizacoesFiltradas.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning("🔍 Nenhuma revitalização encontrada para o mês/ano selecionado.", {
                position: "top-center",
                autoClose: 4000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        try {
            ...
            let fileName = "evidencias-revitalizacoes-".concat(mesAno, ".pdf"); // fallback
                ...
                children: [
                    ...
                    filtered.length > 0 && mesAno && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            revitalizacoesCompletas.filter((r)=>r.data.startsWith(mesAno)).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(EvidenciasRevitalizacoesPage, "m98HcNHHTd445PQ57oYJxlgTKr0=");
_c = EvidenciasRevitalizacoesPage;
var _c;
__turbopack_context__.k.register(_c, "EvidenciasRevitalizacoesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e3c8fa63._.js.map