...
"[project]/app/relatorios/novo-ecopontos-lote/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NovoEcopontosLotePage() {
    _s();
    const [assunto, setAssunto] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Serviços Rotineiros - Ecopontos");
    ...
    const [dataFim, setDataFim] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [sub, setSub] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("CV");
    const [tipoPeriodo, setTipoPeriodo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("semana");
    const [diasEcopontos, setDiasEcopontos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const gerarDiasPeriodo = ()=>{
        ...
        while(dataAtual <= dataFinal){
            ...
            const dataISO = "".concat(ano, "-").concat(mes, "-").concat(dia);
            dias.push({
                data: dataISO,
                ecopontos: [],
                fotos: {}
    ...
    function compressImage(file) {
        let maxWidth = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 800, quality = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0.7;
        return new Promise((resolve)=>{
        ...
        input.onchange = (e)=>{
            ...
            if (files && files.length > 0) {
                ...
                if (currentFotos.length + fileArray.length > 10) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Máximo de 10 fotos por ecoponto. Você já tem ".concat(currentFotos.length, " foto(s) para este ecoponto."));
                    return;
                }
    ...
    const removeFotoEcopontoDia = (diaIndex, ecoponto, fotoIndex)=>{
        setDiasEcopontos((prev)=>{
            ...
            novoDia.fotos = {
                ...novoDia.fotos,
                [ecoponto]: ((_novoDia_fotos_ecoponto = novoDia.fotos[ecoponto]) === null || _novoDia_fotos_ecoponto === void 0 ? void 0 : _novoDia_fotos_ecoponto.filter((_, i)=>i !== fotoIndex)) || []
            };
            novosDias[diaIndex] = novoDia;
            return novosDias;
        });
    ...
    const salvarTodos = async ()=>{
        // Validações
        if (!dataInicio || !dataFim) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Por favor, selecione o período (data início e fim).");
            return;
        }
        if (diasEcopontos.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Nenhum dia foi gerado para o período selecionado.");
            return;
        }
        ...
        if (diasComEcopontos.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Por favor, selecione pelo menos um ecoponto para pelo menos um dia.");
            return;
        }
        setSaving(true);
        let sucessos = 0;
        ...
        try {
            ...
            for (const dia of diasComEcopontos){
                ...
                try {
                    ...
                    console.error("Erro ao salvar relatório do dia ".concat(dia.data, ":"), error);
                    erros++;
                }
            }
            // Tentar limpar relatórios antigos se houve erros
            if (erros > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning("Alguns registros falharam. Tentando limpar relatórios antigos...");
                ...
                for (const dia of diasComEcopontos){
                    if (erros > 0) {
                        ...
                        try {
                            ...
                            console.error("Erro persistente no dia ".concat(dia.data, ":"), retryError);
                        }
                    }
                }
            }
            if (sucessos > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("".concat(sucessos, " relatório(s) salvo(s) com sucesso!"));
                if (erros > 0) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("".concat(erros, " relatório(s) falharam. Verifique o console para detalhes."));
                }
                setTimeout(()=>{
                    window.location.href = "/relatorios";
                }, 2000);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Nenhum relatório foi salvo. Tente novamente com menos fotos.");
            }
        } catch (error) {
            console.error("Erro geral ao salvar relatórios:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao salvar relatórios. Tente novamente.");
        } finally{
            setSaving(false);
        }
    };
    const ecopontosDisponiveis = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ECOPONTOS_POR_SUBREGIAO"][sub] || [];
            ...
            children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                diasEcopontos.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                diasEcopontos.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-6",
                            children: diasEcopontos.map((dia, diaIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-white dark:bg-zinc-800 rounded-lg p-6 border border-zinc-200 dark:border-zinc-700",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: ecopontosDisponiveis.map((ecoponto)=>{
                                                var _dia_fotos_ecoponto;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "space-y-3",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                    type: "checkbox",
                                                                    id: "ecoponto-".concat(diaIndex, "-").concat(ecoponto),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                                    htmlFor: "ecoponto-".concat(diaIndex, "-").concat(ecoponto),
                                                        ...
                                                        dia.ecopontos.includes(ecoponto) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "space-y-2",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            ...
                                                                            children: [
                                                                                "Fotos: ",
                                                                                ((_dia_fotos_ecoponto = dia.fotos[ecoponto]) === null || _dia_fotos_ecoponto === void 0 ? void 0 : _dia_fotos_ecoponto.length) || 0,
                                                                                "/10"
                                                                            ]
                                                                        }, void 0, true, {
                                                                            fileName: "[project]/app/relatorios/novo-ecopontos-lote/page.tsx",
                                                                ...
                                                                dia.fotos[ecoponto] && dia.fotos[ecoponto].length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "grid grid-cols-2 gap-2",
                                                                    children: dia.fotos[ecoponto].map((foto, fotoIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "relative",
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                                    src: foto,
                                                                                    alt: "".concat(ecoponto, " - Foto ").concat(fotoIndex + 1),
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        " ",
                                        dataInicio === null || dataInicio === void 0 ? void 0 : dataInicio.toLocaleDateString('pt-BR'),
                                        " a ",
                                        dataFim === null || dataFim === void 0 ? void 0 : dataFim.toLocaleDateString('pt-BR')
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/app/relatorios/novo-ecopontos-lote/page.tsx",
                                    lineNumber: 505,
...
_s(NovoEcopontosLotePage, "jKk9Om/siDi2BLuKQSOpo6vg/5o=");
_c = NovoEcopontosLotePage;
var _c;
__turbopack_context__.k.register(_c, "NovoEcopontosLotePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ec2a4a51._.js.map